...
//
// Unlike test-lab/test-data/ (which stress-tests the color engine itself against a
...
//
// Run: npx tsx test-lab/preset-data/run.ts             # every discovered preset
//      npx tsx test-lab/preset-data/run.ts nmobile      # just nmobile
//      npx tsx test-lab/preset-data/run.ts nmobile carbon
//
// Open test-lab/preset-data/results/dashboard.html when done.
...
async function main() {
  ...
  console.log("\nDone. Open test-lab/preset-data/results/dashboard.html to view it.");
}
