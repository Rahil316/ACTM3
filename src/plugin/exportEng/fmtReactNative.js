/**
 * exportEng/fmtReactNative.js
 * React Native TypeScript — typed token objects with mode switching.
 * index.ts — barrel with useTokens() helper and Tokens type
 * [theme].ts — per-theme typed token object
 */
