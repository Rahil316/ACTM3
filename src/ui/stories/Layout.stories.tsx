...
export const TabBars: StoryObj = {
  render: () => {
    ...
    return (
      <div className="p-4 max-w-sm bg-n-bg-app rounded-lg border border-n-br-default">
        <TabBar
          tabs={[
        ...
        />
        <div className="mt-4 text-n-tx-muted text-[12px]">
...
export const Collapsibles: StoryObj = {
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-4 p-4 max-w-sm bg-n-bg-app rounded-lg border border-n-br-default">
        <Collapsible
          open={open1}
          onToggle={() => setOpen1(!open1)}
          header={<span className="text-[12px] font-medium">Global Variable Settings</span>}
        >
          <div className="p-2 text-n-tx-muted text-[12px]">
    ...
    return (
      <div className="p-4 max-w-sm bg-n-bg-app rounded-lg border border-n-br-default">
        <SettingsCard>
          ...
          />
          <hr className="border-n-br-default" />
          <SmallRow
            label="Active collection name"
            control={<span className="font-mono text-n-tx-muted">_scale</span>}
          />
        </SettingsCard>
      </div>
    );
...
export const EditableLists: StoryObj = {
  render: () => {
    ...
    return (
      <div className="p-4 max-w-sm bg-n-bg-app rounded-lg border border-n-br-default space-y-2">
        <h4 className="text-n-tx-muted text-[11px] uppercase tracking-wider font-bold mb-2">Editable List</h4>
...
export const BottomSheet: StoryObj = {
  render: () => {
    ...
    return (
      <div className="p-4 max-w-sm bg-n-bg-app rounded-lg border border-n-br-default relative min-h-[300px] flex items-center justify-center">
        ...
        <Sheet open={sheetOpen}>
          <div className="p-5 flex flex-col gap-3">
            <h3 className="text-[16px] font-bold text-n-tx-primary">Theme Shop Presets</h3>
            <p className="text-n-tx-muted text-[12px]">
...
export const ScreenHeaders: StoryObj = {
  render: () => (
    <div className="flex flex-col gap-4 p-4 bg-n-bg-app rounded-lg border border-n-br-default w-full max-w-md">
      <div>
        <p className="text-n-tx-muted text-[10px] uppercase tracking-wider font-bold mb-2">Default Header</p>
        <ScreenHeader
          title="Color Scales"
      ...
      <div>
        <p className="text-n-tx-muted text-[10px] uppercase tracking-wider font-bold mb-2">With Actions</p>
        <ScreenHeader
          title="Figma Export"
