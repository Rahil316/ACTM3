...
function ColorCardStory() {
  ...
  if (!color) return <div className="text-n-tx-muted text-[12px]">No color available in store.</div>;
  return (
    <div className="p-4 max-w-sm bg-n-bg-app border border-n-br-default rounded-lg">
...
function RoleCardStory() {
  ...
  if (!role) return <div className="text-n-tx-muted text-[12px]">No role available in store.</div>;
  return (
    <div className="p-4 max-w-sm bg-n-bg-app border border-n-br-default rounded-lg">
...
export const Toolbar: StoryObj = {
  render: () => (
    <div className="flex flex-col gap-6 p-4 bg-n-bg-app rounded-lg border border-n-br-default max-w-md">
      <div>
        <p className="text-n-tx-muted text-[10px] uppercase tracking-wider font-bold mb-2">Card Hover Container (Hover to reveal toolbar)</p>
        <div className="group/card relative w-64 h-24 border border-n-br-default bg-n-sf-default rounded-[12px] flex items-center justify-center transition-colors hover:border-n-br-strong">
          <span className="text-n-tx-muted text-[11px]">Hover over me</span>
      ...
      <div className="border-t border-n-br-default pt-4">
        <p className="text-n-tx-muted text-[10px] uppercase tracking-wider font-bold mb-2">Toolbar with Custom Slot Actions (Hover to reveal)</p>
        <div className="group/card relative w-64 h-24 border border-n-br-default bg-n-sf-default rounded-[12px] flex items-center justify-center transition-colors hover:border-n-br-strong">
          <span className="text-n-tx-muted text-[11px]">Hover over me</span>
