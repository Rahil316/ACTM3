 ...
 * ├─────────────────┼───────────────────────────────────────────────────────────┤
 * │ TEST-02         │ Direct mode · resolveTokensDirectly=true · no scale col   │
...
const test01: Preset = {
  ...
  badge: 'T01',
  description:
    'Scale mode · Natural algo · 11 steps · contrast mapping · global variations · 2 themes · alpha tints · descriptions on · scale collection on',
...
// ─────────────────────────────────────────────────────────────────────────────
// Exercises:
//   pluginMode='direct', resolveTokensDirectly=true (tokens store hex, no scale collection)
...
const test02: Preset = {
  ...
  badge: 'T02',
  description:
    'Direct mode · resolveTokensDirectly=true · no scale collection · 5 roles each using a different solver: natural / saturated / luminance / hue-locked / chroma-maximized',
...
const test03: Preset = {
  ...
  badge: 'T03',
  description:
    'localBg.kind="hex" · value={Light:"#E5E7EB", Dark:"#1F2937"} · on-surface role contrast is vs explicit hex not page bg · companion role has no localBg for comparison',
  ...
  config: {
    ...
    colors: [
      { _id: 't03-c1', name: 'Blue', shorthand: 'bl', value: '2563EB', description: 'Blue — primary' },
    ],
...
const test04: Preset = {
  ...
  badge: 'T04',
  description:
    'localBg.kind="color" · value="Sand" (named color in palette) · _resolveLocalBg maps to { light: sand.value, dark: sand.value } · same bg hex for all themes · role on-sand contrast vs Sand hex',
...
const test05: Preset = {
  ...
  badge: 'T05',
  description:
    'localBg.kind="token", dynamic=false · value="Blue/fill/default" → localBgTokenRef set · two-pass engine: resolveTokenRefBgs() resolves token per theme · on/fill contrast vs fill/default hex',
  ...
  config: {
    ...
    colors: [
      { _id: 't05-c1', name: 'Blue', shorthand: 'bl', value: '1D4ED8', description: 'Deep blue' },
    ],
...
const test06: Preset = {
  ...
  badge: 'T06',
  description:
    'localBg.kind="token", dynamic=true · value="[color]/fill/default" → localBgDynamicRef set · resolveTokenRefBgs replaces [color] per color → localBgPerColor · Blue on/fill vs Blue fill/default, Red on/fill vs Red fill/default',
...
const test07: Preset = {
  ...
  badge: 'T07',
  description:
    '3 colors · 3 roles: (A) scopedColorIds=null → all colors; (B) scopedColorIds=[] → no colors; (C) scopedColorIds=["t07-c2"] → Green only · exercises scope filtering in engine',
...
const test08: Preset = {
  ...
  badge: 'T08',
  description:
    'mappingMethod="index" · indexTargets=[2] picks step 2 · indexTargets=[8] picks step 8 · contrast-mapped companion role for comparison · scale mode',
  ...
  config: {
    ...
    colors: [
      { _id: 't08-c1', name: 'Violet', shorthand: 'vi', value: '7C3AED', description: 'Violet' },
    ],
...
const test09: Preset = {
  ...
  badge: 'T09',
  description:
    'perRoleVariationOverride=true · role A: customVariationList=true, 3 custom variations (bg/fill/text) · role B: customVariationList=false, uses global 5 variations · same color, different variation counts',
  ...
  config: {
    ...
    colors: [
      { _id: 't09-c1', name: 'Cyan', shorthand: 'cy', value: '0891B2', description: 'Cyan' },
    ],
...
const test10: Preset = {
  ...
  badge: 'T10',
  description:
    'useShorthandColors/Roles/Variations/Steps all=true · tokenNameSegments=["role","color","variation"] (role-first ordering) · scaleStepNames with shorthand map · all token names use short labels',
...
const test11: Preset = {
  ...
  badge: 'T11',
  description:
    'scaleStepNames: 7 named steps (50→900 T-shirt) with shorthands (xs→3xl) · useShorthandSteps=true · scaleLength=7 · tests _parseStepNames + _parseStepShorthands in translateConfig',
...
const test12: Preset = {
  ...
  badge: 'T12',
  description:
    'algorithmScopeLevel="color" · 7 colors × 7 algorithms: Natural / Uniform / Expressive / Symmetric / OKLCH / Material / Linear · each color independently uses a different scale generation algorithm',
...
const test13: Preset = {
  ...
  badge: 'T13',
  description:
    '3 themes (Light, Dark, Brand) + 1 duplicate "Light" → deduped to "Light 2" · tokenGrouping="role" → role-keyed output · custom collection names · exercises _deduplicateThemeNames',
  ...
  config: {
    ...
    colors: [
      { _id: 't13-c1', name: 'Brand', shorthand: 'br', value: '0055CC', description: 'Brand blue' },
    ],
...
const test14: Preset = {
  ...
  badge: 'T14',
  description:
    'includeSourceColors=true · sourceCollectionName="palette/raw" · includeAlphaTints=true · alphaValues="5,10,20,30,50,75,90" (7 values) · 3 brand colors → 7 alpha opacity variants each in source collection',
...
const test15: Preset = {
  ...
  badge: 'T15',
  description:
    '1 color · 1 role · 1 variation · 1 theme · all optional features off · default names · no shorthands · no alpha · no source colors · no step names · minimum viable config',
  ...
  config: {
    ...
    colors: [
      { _id: 't15-c1', name: 'Blue', shorthand: 'bl', value: '3B82F6', description: '' },
    ],
