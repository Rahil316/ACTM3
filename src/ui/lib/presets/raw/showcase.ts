...
const scaleShowcase: Preset = {
  ...
  badge: 'TW',
  description:
    'Scale mode showcase. Every feature enabled: 15 nested colors, 9 roles with custom variations, status roles scoped to their color, alpha tints, scale collection, per-color algorithm.',
...
const directShowcase: Preset = {
  ...
  badge: 'TW',
  description:
    'Direct mode showcase. Every feature: 15 nested colors, localBg on on/fill (dynamic token ref per color), per-role solver overrides, alpha tints, 3 themes, scoped status roles.',
