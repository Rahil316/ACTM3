...
const inputsUI = {
  ...
  actionButton: (label, onClick, extra = {}) => inputsUI.btn("dashed", { label, onclick: onClick, size: "xl", class: "w-full", ...extra }),
  ...
  /**
   * @param {"primary" | "secondary" | "ghost" | "danger" | "icon" | "dashed" | "danger-solid"} variant
   * @param {object} [opts]
   * @param {string} [opts.label]
   * @param {string} [opts.icon]
   * @param {boolean} [opts.disabled]
   * @param {"xs" | "sm" | "md" | "lg" | "xl"} [opts.size]
   * @param {boolean} [opts.square]
