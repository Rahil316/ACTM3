      ...
      {segments.map((seg) => {
        ...
        return (
          <button
            ...
            className={clsx(
              "grow shrink-0 basis-auto h-7 px-2.5 text-[11px] font-semibold rounded-[6px] cursor-pointer transition-all duration-150 whitespace-nowrap flex items-center justify-center gap-1",
