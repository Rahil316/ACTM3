...
const TYPE_VARS: Record<BannerType, React.CSSProperties> = {
  warning: { '--bn-bg': 'rgba(234,179,8,.09)',  '--bn-border': 'rgba(234,179,8,.28)',  '--bn-text': 'rgb(253,224,71)',        '--bn-icon': 'rgb(250,204,21)'        } as React.CSSProperties,
  error:   { '--bn-bg': 'rgba(239,68,68,.09)',  '--bn-border': 'rgba(239,68,68,.28)',  '--bn-text': 'rgb(252,165,165)',       '--bn-icon': 'rgb(248,113,113)'        } as React.CSSProperties,
  info:    { '--bn-bg': 'rgba(59,130,246,.09)', '--bn-border': 'rgba(59,130,246,.28)', '--bn-text': 'rgb(147,197,253)',       '--bn-icon': 'rgb(96,165,250)'         } as React.CSSProperties,
  success: { '--bn-bg': 'rgba(34,197,94,.09)',  '--bn-border': 'rgba(34,197,94,.28)',  '--bn-text': 'rgb(134,239,172)',       '--bn-icon': 'rgb(74,222,128)'         } as React.CSSProperties,
  neutral: { '--bn-bg': 'rgba(255,255,255,.03)','--bn-border': 'rgba(255,255,255,.09)','--bn-text': 'rgba(255,255,255,.55)', '--bn-icon': 'rgba(255,255,255,.4)'    } as React.CSSProperties,
};
