...
// Lucide icons are re-exported for use throughout the app.
...
export {
  ...
  Plus             as LucidePlus,
  // Actions
  Eye              as LucidePreview,
  Play             as LucideRun,
  RotateCcw        as LucideReset,
  Upload           as LucideImport,
  Download         as LucideExport,
  Save             as LucideSave,
  ...
  ShoppingBag      as LucideShop,
  MoreHorizontal   as LucideMore,
  WandSparkles     as LucideWand,
  Zap              as LucideZap,
  ...
  FileCode2        as LucideFileCode,
  FileJson2        as LucideFileJson,
...
export function IconSunMoon({ className }: IconProps) {
  return (
    <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
